# reading the data for training purpose
...
class DataIngestionConfig:
    train_data_path:str=os.path.join('artifacts',"train.csv")#this is the class variable ,the data ingestion o/p will store in this folder  
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        #read the data from database where it stored
        logging.info("Entered the data ingestion data method or component")
        try:
            ...
            logging.info("the train test split is initiated ")
